...
from .views.quiz import api_quizzes, api_quiz_view, add_quiz, quiz_view
from .views.flashcard import flashcard_view, all_flashcards_view, add_flashcard_view, delete_flashcard_view
...
urlpatterns = [
    ...
    path("quizzes/quiz/<uuid:id>", quiz_view, name="quiz view"),
    path("flashcard/delete", delete_flashcard_view, name="delete flashcard"),
]